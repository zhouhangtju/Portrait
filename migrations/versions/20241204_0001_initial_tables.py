...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("qa_pairs", sa.text, nullable=True, comment="问答对列表（JSON字符串）"),
        sa.Column("satisfaction_llm_res", sa.String(255), nullable=True, comment="满意度模型返回结果"),
        sa.Column("emotion_llm_res", sa.String(255), nullable=True, comment="情绪模型返回结果"),
        sa.Column("emotion_asr_res", sa.String(255), nullable=True, comment="情绪asr模型返回结果"),
        sa.Column("complaint_llm_res", sa.String(255), nullable=True, comment="投诉模型返回结果"),
        sa.Column("churn_llm_res", sa.String(255), nullable=True, comment="流失模型返回结果"),
