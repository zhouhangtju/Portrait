    ...
    async for session in get_portrait_db():
        try:
            ...
            await session.execute(text("""
                ...
                ADD COLUMN IF NOT EXISTS visit_and_reason VARCHAR(512),
                ...
                ADD COLUMN IF NOT EXISTS emotion_asr_res VARCHAR(255),
                ADD COLUMN IF NOT EXISTS complaint_llm_res VARCHAR(255),
